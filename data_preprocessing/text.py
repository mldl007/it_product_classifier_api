...
class TextPreprocessor:
    ...
    def __remove_punct(self, string_series: pd.Series):
        ...
        clean_string_series = string_series.str.replace(pat=f'[{puncts}]', repl=" ", regex=True).copy()
    ...
    def preprocess(self, string_series: pd.Series, dataset: str = "train"):
        ...
        string_series = string_series.apply(lambda x: unidecode.unidecode(x)).copy()
        string_series = string_series.str.replace("e-mail", "email", case=False, regex=False)
        string_series = string_series.str.replace("-", "_", case=False, regex=False)
        string_series = string_series.str.replace("'s", " ", case=False, regex=False)
        string_series = string_series.str.replace("'d", " ", case=False, regex=False)
        string_series = string_series.str.replace("'t", " not ", case=False, regex=False)
        if self.lemmatize:
